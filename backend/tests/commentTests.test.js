...
describe('Create comments', () => {
    ...
    it('should create a new comment with authentication', async () => {
      try {
        ...
        console.error('Error during comment creation with authentication:', error);
    ...
    it('should not create a new comment without authentication', async () => {
        try {
          ...
          console.error('Error during comment creation without authentication:', error);
      ...
      it('should not create a new comment with missing fields', async () => {
        ...
        res.body.errors.author.should.have.property('message').eql('Path `author` is required.'); 
  ...
  describe('Update comments', () => {
    ...
    it('should handle server errors during comment update', async () => {
        ...
        sinon.stub(Comment, 'findByIdAndUpdate').throws(new Error('Simulated server error'));
...
describe('Delete comments', () => {
    ...
    it('should delete an existing comment', async () => {
      ...
      it('should handle server errors during comment deletion', async () => {
        ...
        sinon.stub(Comment, 'findByIdAndDelete').throws(new Error('Simulated server error'));
